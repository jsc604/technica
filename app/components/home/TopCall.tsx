    ...
    <div className="grid md:grid-cols-2 my-8 gap-6 w-11/12 h-80 lg:h-96 xl:h-112 mx-auto">
      <div className="relative">
        ...
        <div className="flex justify-center w-full absolute top-3/4 left-0 z-20">
          <Link
            className="text-center bg-sky-600 w-fit min-w-[200px] md:min-w-[300px] hover:bg-sky-500 text-3xl text-white px-6 py-2 rounded-md font-semibold transform -translate-y-1/2"
            href="/book"
          >
