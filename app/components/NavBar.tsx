      ...
      <nav className="w-5/6 flex items-center py-5 justify-center md:justify-between mx-auto text-center">
        ...
        <div>
          <ul className="hidden md:flex uppercase">
            <li className="pl-7 hover:text-green-500"><Link href="/detailing">Detailing</Link></li>
            <li className="pl-7 hover:text-green-500"><Link href="#">Ceramic Coating</Link></li>
            <li className="pl-7 hover:text-green-500"><Link href="#">Get a quote</Link></li>
            <li className="pl-7 hover:text-green-500"><Link href="#">Products & Gear</Link></li>
            <li className="pl-7 hover:text-green-500"><Link href="/about">About</Link></li>
          </ul>
        </div>
        {!sidebarVisible && (
