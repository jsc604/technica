  ...
  return (
    <section>
      <div className="mx-auto w-11/12 mb-12 text-center">
        <button className="text-yellow-400 rounded-full mx-auto hover:underline" onClick={handleClick}>
          Learn More{' '}
          {infoDropDown ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 w-11/12 mx-auto mb-12">
        <div className="rounded-2xl sm:rounded-3xl shadow-full shadow-yellow-400 bg-black">
          <h2 className="font-semibold text-xl text-center p-4 rounded-t-2xl sm:rounded-t-3xl bg-yellow-400 text-black">Upgraded Exterior Detail</h2>
        ...
        <div className="rounded-2xl sm:rounded-3xl shadow-full shadow-yellow-400 bg-black">
          <h2 className="font-semibold text-xl text-center p-4 rounded-t-2xl sm:rounded-t-3xl bg-yellow-400 text-black">Upgraded Interior Detail</h2>
        ...
        <div className="rounded-2xl sm:rounded-3xl shadow-full shadow-yellow-400 bg-black">
          <h2 className="font-semibold text-xl text-center p-4 rounded-t-2xl sm:rounded-t-3xl bg-yellow-400 text-black">Complete Upgraded Detail</h2>
