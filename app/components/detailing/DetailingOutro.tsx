...
const DetailingOutro = () => {
  return (
    <section className="mx-auto text-center my-16">
      <div className="w-5/6 mx-auto items-center">
        <h2 className="font-semibold text-4xl my-4 text-stone-300">Book Your Appointment Today</h2>
        <h2 className="text-xl mt-4 mb-12 text-stone-400">Reveal a breathtaking finish that will leave you in awe</h2>
      ...
      <div className="grid ml:grid-cols-5 gap-6 w-5/6 mx-auto my-20">
        ...
        <div className="ml:col-span-3 rounded-2xl sm:rounded-3xl bg-black max-h-96">
          <Image className="w-full h-full rounded-2xl sm:rounded-3xl object-cover" src={lexus} width={1992} height={1500} alt="lexus" />
        </div>
      </div>
    </section>
  )
